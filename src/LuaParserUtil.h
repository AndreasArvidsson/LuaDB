...
public:
    ...
    static void luaToJson(lua_State* L, std::string& jsonOut, int index, bool pretty = false, int depth = 0);
...
private:
    ...
    static void luaTableToJson(lua_State* L, std::string& jsonOut, int index, bool pretty = false, int depth = 0);
    static void luaDocumentToJson(lua_State* L, std::string& jsonOut, int index, bool pretty = false, int depth = 0);
    static void luaArrayToJson(lua_State* L, std::string& jsonOut, int index, bool pretty = false, int depth = 0);
    static const std::string getIndent(int numIndents);
